<script setup lang="ts">
	...
	function stepIndicatorClass(index: number): string {
		...
		return "border-2 border-neutral-200 dark:border-neutral-700";
	}
...
<template>
	<div class="flex flex-col h-dvh bg-white dark:bg-neutral-900">
		...
		<div class="flex-1 flex flex-col items-center justify-center px-6 gap-8">
			...
			<!-- Progress steps card -->
			<div class="bg-white dark:bg-neutral-800 rounded-2xl shadow-md px-6 py-5 w-full max-w-85.5 flex flex-col gap-4">
