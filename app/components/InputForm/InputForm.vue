<script setup lang="ts">
	...
	const isNotPhone = useMediaQuery("(min-width: 641px)");
</script>
<template>
	<div class="flex flex-col h-dvh bg-white dark:bg-neutral-900">
		<!-- Dev-only toolbar -->
		<InputFormDevToolbar v-if="isDev && isNotPhone" />
		...
		<div class="flex-1 overflow-y-auto pb-34">
			...
			<div class="px-6 py-4 flex flex-col gap-2">
				<label class="text-sm font-medium text-neutral-900 dark:text-neutral-100">Weekly Budget</label>
				<div
					class="border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 rounded-xl flex items-center gap-2 p-2 focus-within:border-primary-500 transition-colors">
					<!-- Currency selector -->
					...
					<input
						...
						min="0"
						placeholder="0"
						class="flex-1 bg-transparent outline-none text-base text-neutral-900 dark:text-neutral-100 placeholder:text-neutral-300 dark:placeholder:text-neutral-600"
						@input="onBudgetInput" />
				</div>
			...
			<div class="px-6 py-4 flex flex-col gap-4">
				<div class="grid gap-2">
					<label class="text-sm font-medium text-neutral-900 dark:text-neutral-100">Meals Per Day</label>
					<UISegmentedToggle
						v-model="mealsPerDay"
						:options="[
				...
				<div class="grid gap-2">
					<label class="text-sm font-medium text-neutral-900 dark:text-neutral-100">Days of the Week</label>
					<UISegmentedToggle
			...
			<div class="px-6 py-4 flex flex-col gap-3">
				<label class="text-sm font-medium text-neutral-900 dark:text-neutral-100">Dietary Preference</label>
				<div class="flex flex-nowrap gap-2">
					<button
						...
						:class="
							store.dietaryPreference === opt.value
		...
		<!-- Fixed CTA -->
		<div class="fixed bottom-0 inset-x-0 z-20 bg-white dark:bg-neutral-900 px-6 pt-4 pb-[max(16px,env(safe-area-inset-bottom))]">
			<UButton
				block
